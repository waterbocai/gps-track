...
class WxPayConf_pub(object):  
    ...
    APPID = 'wx50365cfee93894d6'  
    #JSAPI接口中获取openid，审核后在公众平台开启开发模式后可查看  
    APPSECRET = '49174c0efe513fa826e1f47b335c6fa8'  
    #受理商ID，身份标识  
    MCHID = "1230954302"  
    #商户支付密钥Key。审核通过后，在微信发送的邮件中查看  
    KEY = "GXSWei2HQWen0YCFu1CYLiang4WSTian"  
     
  
    #=======【异步通知url设置】===================================  
    #异步通知url，商户根据实际开发过程设定  
    NOTIFY_URL = "%s/m/payresult"%myDomain 
  
    #=======【JSAPI路径设置】===================================  
    #获取access_token过程中的跳转uri，通过跳转将code传入jsapi支付页面  
    JS_API_CALL_URL = "http://gxsaiwei.sinaapp.com/m/ticketbook/?showwxpaytitle=1"  
  
    #=======【证书路径设置】=====================================  
    #证书路径,注意应该填写绝对路径  
    SSLCERT_PATH = "/static/cert/apiclient_cert.pem"  
    SSLKEY_PATH = "/static/cert/apiclient_key.pem"  
...
class UrllibClient(object):  
    ...
    def postXml(self, xml, url, second=30):  
        """不使用证书"""  
        data = urllib2.urlopen(url, xml, timeout=second).read().decode("utf-8")  
        return data  
